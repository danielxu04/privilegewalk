    ...
    return(
        <React.Fragment>
            <div className="text-xl text-center mt-[6vw] flex flex-col items-center">
                <h2 className="font-interBold text-6xl cream-text cream-textshadow pb-[4vw]">Privilege Walk</h2>
                <p className="font-montserratRegular text-md cream-text pb-[6vw] md:px-[20vw] xl:text-lg">
                    Welcome to <strong className="darkcream-text darkcream-textshadow">Discourse Agency's</strong> interactive Privilege Walk.
                    <br /><br /> 
                    In society, privileged groups can often benefit, often to the detriment of other parties. This advantage can often stem from
